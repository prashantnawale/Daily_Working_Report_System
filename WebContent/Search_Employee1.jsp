...
<title>Search_Employee_For_Monthly_report</title>
...
<body>
		...
		<form action="Search_Monthly_Report_Detail_Validation" method="post">

<br>
					    <div class="Heading">
								
								<h3>Search Monthly Report Detail</h3>
						</div>
	...
	<h5> 
						...
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		   				...
		   				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
							Branch Name:	
										 ...
										 <option value="AHMEDNAGAR HO">AHMEDNAGAR HO</option>										  <option value="MONDHA">MONDHA</option>
					...
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
								...
								&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
									...
									<button onclick="location.href='All_Employee_Monthly_Report'" type="button">
      													   Search_All</button>
