...
<%
		...
		try
				{
					...
					ResultSet rs=st.executeQuery("select * from Monthly_report1 where Employee_Id='"+Employee_Id+"' and Date1='"+Date1+"'");
					while(rs.next())
				{
	%>
	...
	<td>
	<a href='Edit_Monthly_Report1.jsp?Employee_Id=<%=rs.getString("Employee_Id") %>'>Edit</a>
	</td>
