...
<title>Edit Monthly Employee Report</title>
...
<%
		...
		try
		{
			...
			ResultSet rs=st.executeQuery("select * from Monthly_report1 where Employee_Id='"+Employee_Id+"'");
			while(rs.next())
		{
			%>
			
			 <div>  
			<form action="Final_Monthly_Edited_Report.jsp"  method="post">
			
			<br>
			<div class="mark">
			<center>
			<h3 style="color: red;">Edit Monthly Employee Report</h3>
			</center>
			</div>
			<br>
			...
			<h5> 
				...
				List_Of_Month_Started_Work:	
											&nbsp;&nbsp;&nbsp;&nbsp;
					
				<input type ="text" name="Started_Work" placeholder="Started_Work"  required="Started_Work" value="<%=rs.getString("Started_Work")%>">
				...
				End_Of_The_Month_Completed_Work:		
												&nbsp;
						
				<input type ="text" name="Completed_Work" placeholder="Completed_Work" required="Completed_Work" value="<%=rs.getString("Completed_Work")%>">
				...
				<input type ="text" name="Remaining_Work" placeholder="Remaining_Work" required="Remaining_Work" value="<%=rs.getString("Remaining_Work")%>">
			   ...
			   <input type ="text" name="Other_Work" placeholder="Other_Work" required="Other_Work" value="<%=rs.getString("Other_Work")%>">
