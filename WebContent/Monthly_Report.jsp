...
<title>Monthly Report Detail</title>
...
<body>
		...
		<form action="Monthly_Report_Detail_Validation" method="post">
...
<br>
						...
						<a href='Completed_Monthly_Work.jsp'>Submit_Monthly_Completed_Work?</a>
			...
			%>
				...
				<%-- 				<textarea  type='text' id="Started_Work" name="Started_Work" rows="3" cols="73">	</textarea>		--%>
								...
								List_Of_Month_End_Completed_Work:		
																	&nbsp;
								
								<textarea   id="LCompleted_Work" name="Completed_Work" rows="3" cols="73">   </textarea>
