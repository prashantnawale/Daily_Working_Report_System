...
<title>Employee Employee11</title>
...
<%
		...
		try
				{
					...
					ResultSet rs=st.executeQuery("select * from Daily_report1 where Employee_Id='"+Employee_Id+"' and Date1='"+Date1+"'");
					while(rs.next())
				{
	%>
	...
	<td>
	<a href='Edite_Daily_Report1.jsp?Employee_Id=<%=rs.getString("Employee_Id") %>' and href='Edite_Daily_Report1.jsp?Date1=<%=rs.getString("Date1") %>'>Edit</a>
	</td>
