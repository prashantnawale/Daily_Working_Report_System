...
/**
 * Servlet implementation class create_monthly_Login_Validation
 */
@WebServlet("/create_monthly_Login_Validation")
public class create_monthly_Login_Validation extends HttpServlet {
	...
	protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		// TODO Auto-generated method stub
	        ...
	        String confirmpassword=request.getParameter("confirmpassword");
	         ...
	         PreparedStatement ps = con.prepareStatement("insert into Monthly_login values(?,?,?,?,?)");   //  SELECT * from "+createAccount+" WHERE id=?");
	          ...
	          //int i=ps.executeUpdate();
	           ...
	           response.sendRedirect("Monthly_Work_Login.jsp");
	           }
	           else {
	        	   pw.print("password and confirm password not same");
	        	   response.sendRedirect("Create_Monthly_Work_Login.jsp?msg=Password and ConfirmPassword Not Match");
	           }
