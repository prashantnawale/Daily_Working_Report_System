...
/**
 * Servlet implementation class create_Verify_Work_Login_Validation
 */
@WebServlet("/create_Verify_Work_Login_Validation")
public class create_Verify_Work_Login_Validation extends HttpServlet {
	...
	PrintWriter pw=response.getWriter();
        ...
        String confirmpassword=request.getParameter("confirmpassword");
         ...
         PreparedStatement ps = con.prepareStatement("insert into Verify_login values(?,?,?,?,?)");   //  SELECT * from "+createAccount+" WHERE id=?");
          ...
          //int i=ps.executeUpdate();
           ...
           response.sendRedirect("Verify_Work_Login.jsp");
           }
           else {
        	   pw.print("password and confirm password not same");
        	   response.sendRedirect("Verify_Work_Create_Login.jsp?msg=Password and ConfirmPassword Not Match");
           }
